...
# ===========================================================================
HOST = "dineshyadav03"   # shown as  you@github  in the header
...
ROWS = [
    ...
    ("gap",),
    ("sec", "Stack"),
    ("kv", "AI & ML", "LLMs, Agents, PyTorch, Transformers"),
    ("kv", "Robotics", "ROS, Computer Vision, Simulations"),
    ("kv", "Systems", "Scalable backend & tools"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Creating open-source tools & systems"),
    ("bul", "Building real-world AI applications"),
]
